...
setTimeout(() => {
    ...
    setTimeout(() => {
        ...
        if (newTicketButton) {
            ...
            console.log("Botão para abrir novo ticket não encontrado com o seletor."); // Botão "Abrir Ticket" não encontrado
        }
        ...
        setTimeout(() => {
            function preencherMarca(marca) {
                ...
                if (selectElement) {
                    ...
                    console.log("Elemento da marca não encontrado com o ID."); // Elemento select para a marca não encontrado
                }
            }
            ...
            setTimeout(() => {
                if (brandValue === 'C') {
                    ...
                    console.log("Marca preenchida CB"); // Confirmação de que a marca foi preenchida como Casas Bahia
                } else {
                    preencherMarca("616038478607cd31975c4006_ponto"); // Preenche a marca como Ponto
                    console.log("Marca preenchida PIN"); // Confirmação de que a marca foi preenchida como Ponto
                }
                ...
                setTimeout(() => {
                    function preencherResponsavel(nomeResponsavel) {
                        ...
                        if (selectElement) {
                            ...
                            console.log("Elemento do responsável não encontrado com o selector."); // Elemento select para o responsável não encontrado
                        }
                    }
                    ...
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            if (element1) {
                                ...
                                console.log("Elemento não encontrado com o XPath fornecido."); // Elemento não encontrado com o XPath fornecido
                            }
